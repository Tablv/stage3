...
const config  = require('../sourceDB/dbconfig.js');
...
*/
exports.insertDB = function(Obj,json,callback){
    // 创建对象
    var o = new Obj(json);
    // 保存对象
 ...
 * @param {function} callback  回调函数
*/
exports.deleteDB = function(Obj,filter,callback){
 ...
 * @param {function} callback  回调函数
*/
exports.updataDB = function(Obj,filter,data,callback){
    // 执行修改 update updateone updatemany
    Obj.updateOne(filter,{$set:data},function(err,result){
        callback(err,result);
    });
}
//暴露find方法,向某个集合中查找数据
 ...
 * @param {function} callback  回调函数
*/
exports.findDB=function(Obj,filter,callback){
    // 限制条件 可选参数对象
    var option = {};
